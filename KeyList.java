...
public class KeyList<T extends Comparable<T>> implements KeyListInterface<T> {
     ...
     * @param iterationStartPoint the first object with firstKey
     */
    public KeyList(Comparable<T> iterationStartPoint) {
        if (iterationStartPoint == null) throw new NullPointerException("keys cannot be null");
        keyList = new LinkedList<>();
        keyList.add((T) iterationStartPoint);
    }
